...
import com.shatteredpixel.lovecraftpixeldungeon.effects.BadgeBanner;
...
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndBadge;
...
public class BadgesScene extends PixelScene {
	...
	public void create() {
		...
		float pw = Math.min( w, (LovecraftPixelDungeon.landscape() ? MIN_WIDTH_L : MIN_WIDTH_P) * 3 ) - 16;
		float ph = Math.min( h, (LovecraftPixelDungeon.landscape() ? MIN_HEIGHT_L : MIN_HEIGHT_P) * 3 ) - 32;
