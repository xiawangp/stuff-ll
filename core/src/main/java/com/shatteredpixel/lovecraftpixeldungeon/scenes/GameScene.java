...
import com.shatteredpixel.lovecraftpixeldungeon.effects.EmoIcon;
...
import com.shatteredpixel.lovecraftpixeldungeon.items.bags.SeedPouch;
...
import com.shatteredpixel.lovecraftpixeldungeon.sprites.DiscardedItemSprite;
...
import com.shatteredpixel.lovecraftpixeldungeon.tiles.DungeonWallsTilemap;
import com.shatteredpixel.lovecraftpixeldungeon.tiles.FogOfWar;
import com.shatteredpixel.lovecraftpixeldungeon.tiles.GridTileMap;
import com.shatteredpixel.lovecraftpixeldungeon.tiles.TerrainFeaturesTilemap;
import com.shatteredpixel.lovecraftpixeldungeon.tiles.WallBlockingTilemap;
import com.shatteredpixel.lovecraftpixeldungeon.ui.ActionIndicator;
import com.shatteredpixel.lovecraftpixeldungeon.ui.AttackIndicator;
import com.shatteredpixel.lovecraftpixeldungeon.ui.Banner;
import com.shatteredpixel.lovecraftpixeldungeon.ui.BusyIndicator;
...
import com.shatteredpixel.lovecraftpixeldungeon.ui.HealthIndicator;
import com.shatteredpixel.lovecraftpixeldungeon.ui.Icons;
import com.shatteredpixel.lovecraftpixeldungeon.ui.LootIndicator;
import com.shatteredpixel.lovecraftpixeldungeon.ui.QuickSlotButton;
import com.shatteredpixel.lovecraftpixeldungeon.ui.ResumeIndicator;
import com.shatteredpixel.lovecraftpixeldungeon.ui.StatusPane;
import com.shatteredpixel.lovecraftpixeldungeon.ui.Toast;
import com.shatteredpixel.lovecraftpixeldungeon.ui.Toolbar;
...
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndBag.Mode;
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndGame;
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndHardNotification;
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndHero;
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndInfoCell;
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndInfoItem;
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndInfoMob;
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndInfoPlant;
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndInfoTrap;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		if(Dungeon.depth == 1){
			...
			Music.INSTANCE.play( Assets.SONGCAVES, true );
		} else {
			Music.INSTANCE.play( Assets.SONGTOWN, true );
		}
		...
		case DESCEND:
			...
			case 1:
				...
				add(new WndHardNotification(Icons.BUG.get(), Messages.get(this, "notfinished"), Messages.get(this, "sorry", "1 & 2"), Messages.get(this, "okay"), 1));
				break;
			case 6:
	...
	public static void layoutTags() {
		...
		float tagLeft = LovecraftPixelDungeon.flipTags() ? 0 : uiCamera.width - scene.attack.width();
