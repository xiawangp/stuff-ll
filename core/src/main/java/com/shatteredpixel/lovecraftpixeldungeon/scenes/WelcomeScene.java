...
public class WelcomeScene extends PixelScene {
	...
	public void create() {
		...
		final int previousVersion = LovecraftPixelDungeon.version();

		if (LovecraftPixelDungeon.versionCode == previousVersion) {
		...
		DarkRedButton okay = new DarkRedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				LovecraftPixelDungeon.switchScene(TitleScene.class);
			}
		};
		...
		if (previousVersion != 0){
			DarkRedButton changes = new DarkRedButton(Messages.get(this, "changelist")){
				...
				protected void onClick() {
					super.onClick();
					updateVersion(previousVersion);
					LovecraftPixelDungeon.switchScene(ChangesScene.class);
				}
			};
		...
		} else if (previousVersion <= LovecraftPixelDungeon.versionCode) {
	...
	private void updateVersion(int previousVersion){
		...
		LovecraftPixelDungeon.version(LovecraftPixelDungeon.versionCode);
	}
