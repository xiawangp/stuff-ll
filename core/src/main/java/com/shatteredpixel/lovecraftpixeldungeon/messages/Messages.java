...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.shatteredpixel.lovecraftpixeldungeon.messages.actors.actors",
			"com.shatteredpixel.lovecraftpixeldungeon.messages.items.items",
			"com.shatteredpixel.lovecraftpixeldungeon.messages.levels.levels",
			"com.shatteredpixel.lovecraftpixeldungeon.messages.plants.plants",
			"com.shatteredpixel.lovecraftpixeldungeon.messages.scenes.scenes",
			"com.shatteredpixel.lovecraftpixeldungeon.messages.ui.ui",
			"com.shatteredpixel.lovecraftpixeldungeon.messages.windows.windows",
			"com.shatteredpixel.lovecraftpixeldungeon.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.shatteredpixel.lovecraftpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
