...
public abstract class Char extends Actor {
	...
	private static final String TAG_MH		= "MH";
	private static final String TAG_MMH	    = "MMH";
	...
	public void storeInBundle( Bundle bundle ) {
		...
		bundle.put( TAG_MH, MH );
		bundle.put( TAG_MMH, MMH );
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		MH = bundle.getInt( TAG_MH );
		MMH = bundle.getInt( TAG_MMH );
