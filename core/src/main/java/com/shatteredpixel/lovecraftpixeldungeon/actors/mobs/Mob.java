...
import com.shatteredpixel.lovecraftpixeldungeon.actors.buffs.SoulMark;
...
import com.shatteredpixel.lovecraftpixeldungeon.effects.Surprise;
...
import com.shatteredpixel.lovecraftpixeldungeon.levels.Level.Feeling;
...
public abstract class Mob extends Char {
	...
	public void mentalMinus(int amount, int chance, Char enemy){
		if(Random.Int(chance) == 0 && enemy == Dungeon.hero){
			Dungeon.hero.decreaseMentalHealth(amount);
			GLog.i(Messages.get(this, "mentalminus"));
			enemy.sprite.showStatus( CharSprite.MENTAL, Integer.toString( amount ) );
		}
	}
