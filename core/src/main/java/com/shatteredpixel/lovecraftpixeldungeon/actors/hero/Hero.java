...
public class Hero extends Char {
	...
	private static final String YOURNAME	= "playername";
	...
	public void storeInBundle( Bundle bundle ) {
		...
		bundle.put(YOURNAME, playername);
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		playername = bundle.getString( YOURNAME );
	...
	public boolean act() {
		...
		checkVisibleMobs();
		this.beloningsweight = 0;
		this.belongings.calculateWeight(this);
