...
import com.shatteredpixel.lovecraftpixeldungeon.actors.mobs.Monk;
import com.shatteredpixel.lovecraftpixeldungeon.items.Generator;
import com.shatteredpixel.lovecraftpixeldungeon.items.quest.DwarfToken;
...
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndImp;
		...
		public static void process( Mob mob ) {
			if (spawned && given && !completed) {
				...
				if ((alternative && mob instanceof Monk) ||
					(!alternative && mob instanceof MiGo)) {
