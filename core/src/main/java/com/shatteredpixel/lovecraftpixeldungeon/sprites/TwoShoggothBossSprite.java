...
public class TwoShoggothBossSprite extends MobSprite {
	...
	public TwoShoggothBossSprite() {
		...
		run.frames( frames, 2, 7, 1, 0 );

		pump = new Animation( 20, true );
		pump.frames( frames, 7, 0, 3, 7, 0, 3, 0, 7, 3, 7, 0, 3 );

		pumpAttack = new Animation ( 20, false );
		pumpAttack.frames( frames, 0, 3, 3, 0, 3, 0, 3);
