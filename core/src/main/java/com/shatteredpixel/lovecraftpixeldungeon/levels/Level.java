...
import com.shatteredpixel.lovecraftpixeldungeon.actors.blobs.Alchemy;
...
import com.shatteredpixel.lovecraftpixeldungeon.effects.particles.FlowParticle;
import com.shatteredpixel.lovecraftpixeldungeon.effects.particles.WindParticle;
...
import com.shatteredpixel.lovecraftpixeldungeon.mechanics.ShadowCaster;
...
public abstract class Level implements Bundlable {
	...
	protected void setupSize(){
		if (width == 0 || height == 0)
			width = height = (generateEvenNumber(30, 50));
		length = width * height;
	}
