...
import com.shatteredpixel.lovecraftpixeldungeon.items.Weightstone;
...
import com.shatteredpixel.lovecraftpixeldungeon.items.food.OverpricedRation;
...
public class ShopPainter extends Painter {
	...
	private static void generateItems() {
		...
		switch (Dungeon.depth) {
            case 1:
				itemsToSpawn.add( (Random.Int( 2 ) == 0 ? Generator.random(Generator.Category.RING) : Generator.random(Generator.Category.WAND) ));
