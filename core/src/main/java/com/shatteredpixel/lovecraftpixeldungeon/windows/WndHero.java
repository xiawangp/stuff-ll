...
public class WndHero extends WndTabbed {
	...
	private class StatsTab extends Group {
		...
		public StatsTab() {
			...
			statSlot( Messages.get(this, "name"), Dungeon.hero.playername );
			...
			statSlot( Messages.get(this, "mentalhealth"), hero.MH + "+/" + hero.MMH );
			...
			statSlot( Messages.get(this, "weight"), Dungeon.hero.beloningsweight );
