...
public class MiGoCap extends HelmetSlot{

    {
        image = ItemSpriteSheet.MIGOCAP;
        weight = 3;
        identify();
    }
    ...
    public boolean doEquip(Hero hero) {
        ((HeroSprite)hero.sprite).changeSkin(new MiGo());
    ...
    public void restoreFromBundle(Bundle bundle) {
        ...
        if(activated){
            ((HeroSprite)curUser.sprite).changeSkin(new MiGo());
