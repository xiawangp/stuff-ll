...
import com.shatteredpixel.lovecraftpixeldungeon.windows.WndJournal;
...
public class StatusPane extends Component {
	...
	public void update() {
		...
		float mentalhealth = Dungeon.hero.MH;
		float maxmentalhealth = Dungeon.hero.MMH;
		...
		if (!Dungeon.hero.isAlive()) {
			...
			//BLOOD IN THE GAME SCENE +
			Dungeon.hero.sprite.tint(ColorMath.interpolate(warning, 0x660000, 0xCC0000, 0x660000), 0.5f );
		...
		mhp.scale.x = Math.max( 0, (mentalhealth)/maxmentalhealth);
