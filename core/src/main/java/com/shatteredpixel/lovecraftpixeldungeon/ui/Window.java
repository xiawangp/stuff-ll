...
import com.shatteredpixel.lovecraftpixeldungeon.effects.ShadowBox;
...
public class Window extends Group implements Signal.Listener<Key> {
	...
	public static final int TITLE_COLOR = 0x11BB11;
	public static final int SHPX_COLOR = 0x8D6CD2;
